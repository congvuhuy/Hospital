...
export class ExcelImportService {
  ...
  importCommuneExcelByFile = (file: IFormFile, config?: Partial<Rest.Config>) =>
  ...
  importDistrictExcelByFile = (file: IFormFile, config?: Partial<Rest.Config>) =>
    this.restService.request<any, ActionResult>({
      method: 'POST',
  ...
  importProvinceExcelByFile = (file: IFormFile, config?: Partial<Rest.Config>) =>
    this.restService.request<any, ActionResult>({
      method: 'POST',
